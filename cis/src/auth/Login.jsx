  ...
  return (
    <div className="body flex justify-center items-center min-h-screen bg-gradient-to-r from-gray-200 to-blue-200"> 
     <div className="container relative w-[850px] h-[550px] bg-white rounded-[30px] shadow-[0 0 30px rgba(0,0,0,.2)">  
      {/* login part */}
      <div className='form-box z-[1] p-10 absolute w-1/2  h-full bg-[#fff] right-0 flex items-center justify-center text-center '>
        ...
        <div className='forgot-pass m-[-15px 0 15px]'>
...
>
  <FaLinkedin />
      ...
      {/* signup part */}
        ...
        <div className='form-box p-[40px] absolute w-[50%] h-[100%] bg-[#fff] right-0 flex items-center justify-center text-center hidden '>
              <form action={''} className='w-[100%] flex flex-col items-center'>
      ...
      >
        <FaLinkedin />
            ...
            <div className="toggle-box absolute w-[100%] h-[100%] ">
              <div className="toggle-panel toggle-left absolute w-[50%] h-[100%]  text-[#fff] flex flex-col justify-center items-center">
                <h1 className='text-[30px]'>Hello, Welcome!</h1>
                <p className="mb-[20px]">Don't have an account ?</p>
<button className="w-[160px] h-[46px] bg-transparent border-2 border-white rounded-md shadow-md text-white font-medium">
  Sign Up
</button>
              </div>
            </div>
