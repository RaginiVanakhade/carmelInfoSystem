    ...
    >
      ...
      >
        ...
        <Box display="flex" justifyContent="center" alignItems="center" mt={1}>
          <Typography
            sx={{ fontSize: 16, fontWeight: 500, color: "#fff", mr: 0.5 }}
          >
            Carmel
          </Typography>
      ...
      {/* ---------- SEARCH ---------- */}
      <Box
        sx={{ p: 1, flexShrink: 0, borderBottom: "1px solid #ccc", margin: 2 }}
      >
        <CustomSearch />
      </Box>
      ...
      <Box sx={{ flexGrow: 1, overflowY: "scroll" }}>
        <List>
          <Typography
            sx={{ fontSize: 13, fontWeight: 500, pl: 2, color: "#1976d2" }}
          >
            Navigation
          </Typography>

          <ListItemButton component={NavLink} to="/dashboard" sx={navItemStyle}>
          ...
          <ListItemButton onClick={toggleMasters} component={NavLink} to="/masters" sx={navItemStyle}>
